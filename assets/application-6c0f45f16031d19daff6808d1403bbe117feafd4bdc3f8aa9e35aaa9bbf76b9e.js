...
function validate_username() {
  ...
  $("input.id_insert").keyup(function(){
    ...
    .attr('src', '/assets/ic_check_white.png');
      $("button.id_confirm")
      .attr("disabled", false)
      .css({
        "color": "white",
    ...
    {
    $("button.id_confirm img")
    .attr('src', '/assets/ic_check_grey.png');
      $("button.id_confirm")
      .attr("disabled", true)
      .css({
        "color": "#cecece",
...
function campaign_list() {
  ...
  $.getJSON(url, function(data){
    ...
    for(i = 0; i < data.length; i++) {
      ...
      var type = data[i].revenu_type;
      var type_txt = '설치형';

      if (i == data.length - 1) {
        var wrapper = "<div class='available_campaign_list campaign_" + i + "' onclick='campaign_popup($(this).html());' style='border-top: 1px solid #e0e2e3;'> <div class='available_campaign thumbnail'><img src='" + thumbnail + "'> </div> <div class='available_campaign title_type'> <div class='available_campaign title'>" + name + "</div> <div class='available_campaign type_1'>설치형" + "</div> </div> <div class='available_campaign coupon'> <img src='/assets/ic_b.png'><div class='coupon_count'>3장</div> </div> </div>";
      }
      else {
        var wrapper = "<div class='available_campaign_list campaign_" + i + "' onclick='campaign_popup($(this).html());'> <div class='available_campaign thumbnail'><img src='" + thumbnail + "'> </div> <div class='available_campaign title_type'> <div class='available_campaign title'>" + name + "</div> <div class='available_campaign type_1'>설치형" + "</div> </div> <div class='available_campaign coupon'> <img src='/assets/ic_b.png'><div class='coupon_count'>3장</div> </div> </div>";
      }
